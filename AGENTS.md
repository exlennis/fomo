# AGENTS.md — FOMO System

Canonical guidance for any agent working in this repository. `CLAUDE.md` imports this
file; keep shared instructions here rather than duplicating them in tool-specific files.
...
Agents do not have API access to the claude.ai project knowledge. Steps 3 and 4 are
user-triggered.
